...
- Extração de dados financeiros de ativos utilizando APIs(yfinance e fundamentus) com a linguagem Python;
...
1. **Quais foram os valores mínimo e máximo registrados pelos ativos entre 01/08/2022 e 01/08/2025?**  
2. **Qual era o valor de mercado e o valor intrínseco dos ativos ?**  
...
Esse projeto foi importantíssimo para que eu desenvolva algumas habilidades necessárias para o dia a dia de um analista de dados do mercado financeiro, utilizando duas poderosas ferramentas como **Python** e **Power BI** para trazer insights valiosos para tomada de decisão. 
